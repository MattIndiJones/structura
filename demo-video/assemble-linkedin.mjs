...
const out=path.join(root,'build','linkedin'); fs.mkdirSync(out,{recursive:true});
...
for(const id of [3,4,5,6,7,8,9]){
 ...
 if(id===4) panels=panel(16,226,395,355,false)+panel(433,452,521,280);
...
const plan=[
 ...
 {id:4,speed:1.15,blur:[[430,330,405,65],[430,735,330,24]]},
 {id:5,speed:1,pricing:true},
 {id:6,speed:1.4,pricing:true},
 {id:7,speed:1,pricing:true},
 {id:8,speed:1,pricing:true},
 {id:9,speed:1.15,pricing:true},
 {id:10,speed:1.6}
];
const parts=[];
for(const [n,s] of plan.entries()){
 const input=path.join(root,'build','seg',String(s.id).padStart(2,'0')+'.mp4');
...
const final=path.join(root,'structura-ai-demo-linkedin-v3.mp4');
