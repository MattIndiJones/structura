...
>
> **Mise à jour du 14/09/2026 (décision D4 du 11/09)** : la valeur est désormais
> **obligatoire** — `PARAM() NOM = valeur[%]`, comme `PARAM`. La forme sans valeur, qui passait à
> 0 % en silence, est refusée par le parser avec un message qui nomme la valeur manquante.
