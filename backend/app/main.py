...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[v.strip() for v in __import__("os").environ.get(
        "STRUCTURA_CORS_ORIGINS", "http://localhost:5173,http://127.0.0.1:5173,http://localhost:8000,http://127.0.0.1:8000"
    ).split(",") if v.strip()],
